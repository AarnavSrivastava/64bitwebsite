...
const Navbar = () => {
    return (
        <navbar className="h-screen flex flex-col sticky top-0 px-[5vw] max-w-[250px] w-[15vw] bg-black justify-center items-center gap-[2.5vw] py-8 xl:text-[24px] md:text-[1vw] text-sm font-RobotoC">
