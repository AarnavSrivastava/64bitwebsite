...
const CharityLink = (props) => {
    return (
        <div className="flex flex-row text-black justify-between gap-[10vw] px-[5vw] font-Inter">
            ...
            <div className="flex flex-col justify-center items-center gap-[5vw] md:basis-11/12">
                ...
                <a target="_blank" rel="noreferrer" href={props.link} className="uppercase font-bold active:ring-4 active:ring-gray-300 px-[2vw] w-[15vw] min-w-[200px] flex md:text-[1vw] text-[1em] font-Poppins md:py-[1vw] py-[1em] justify-center text-center border-2 border-black shadow-lg transition ease-in-out hover:bg-black hover:text-amber-400 hover:scale-125">
                    Donate Now
                </a>
            </div>
        </div>
